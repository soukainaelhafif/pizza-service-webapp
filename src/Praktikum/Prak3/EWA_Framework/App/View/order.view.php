<?php
// Bestellseite (wird vom OrderController aufgerufen)
...
<section class="page-card page-card--orderpage">
    ...
    <form action="index.php" method="post" class="order-form">
            ...
            <?php if (isset($data) && is_array($data)): ?>
                <?php foreach ($data as $article): ?>
                    ...
                    <label class="pizza-card card"
                        ...
                        <!-- Radio, damit dein Controller eine Pizza-ID bekommt -->
                        <input type="radio"
                               name="pizza_id"
                               value="<?= $id ?>"
                               <?= $id === 1 ? 'checked' : '' ?>
        ...
        <div class="cart-box">
            ...
            <!-- Linke Seite: Adresse + Liste + Gesamtpreis -->
            <div class="cart-left">
        ...
        <!-- JSON mit allen Pizzen im Warenkorb (optional für Controller) -->
